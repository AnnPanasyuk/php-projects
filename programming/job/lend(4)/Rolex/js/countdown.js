...
$('.time').countdown({
    ...
    format: 'HMS',
    layout: '<li class="time-bg">0</li><li class="time-bg">0</li><li class="time-bg">{h10}</li><li class="time-bg">{h1}</li><li class="time-bg">{m10}</li><li class="time-bg">{m1}</li><li class="time-bg">{s10}</li><li class="time-bg">{s1}</li>'
});